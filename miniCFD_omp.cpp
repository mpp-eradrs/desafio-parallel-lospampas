...
void do_dir_x( double *state , double *flux , double *tend ) {
  ...
  #pragma omp parallel for private(k, i, stencil, d_vals, vals)
  for (k=0; k<nnz; k++) {
      #pragma omp simd
    for (i=0; i<nnx+1; i++) {
      //Use fourth-order interpolation from four cell averages to compute the value at the interface in question
        ...
        vals[0] = -stencil[0]/12 + 7*stencil[1]/12 + 7*stencil[2]/12 - stencil[3]/12;
        d_vals[0] = -stencil[0] + 3*stencil[1] - 3*stencil[2] + stencil[3];
        ...
        stencil[3] = state[inds];
        vals[1] = -stencil[0]/12 + 7*stencil[1]/12 + 7*stencil[2]/12 - stencil[3]/12;
        d_vals[1] = -stencil[0] + 3*stencil[1] - 3*stencil[2] + stencil[3];
        ...
        stencil[3] = state[inds];
        vals[2] = -stencil[0]/12 + 7*stencil[1]/12 + 7*stencil[2]/12 - stencil[3]/12;
        d_vals[2] = -stencil[0] + 3*stencil[1] - 3*stencil[2] + stencil[3];
        ...
        stencil[3] = state[inds];
        vals[3] = -stencil[0]/12 + 7*stencil[1]/12 + 7*stencil[2]/12 - stencil[3]/12;
        d_vals[3] = -stencil[0] + 3*stencil[1] - 3*stencil[2] + stencil[3];
...
int main(int argc, char **argv) {
  ...
  if (masterproc) {
    std::cout << "CPU Time: " << ( omp_get_wtime() - c_start ) << " sec\n";
  }
